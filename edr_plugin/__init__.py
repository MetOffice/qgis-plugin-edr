...
from edr_plugin.gui.coveragejson_drop_handler import CoverageJSONDropHandler, CoverageJSONItemProvider
...
class EDRPlugin:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.coveragejson_drop_handler = CoverageJSONDropHandler(self.layer_manager)
        self.item_provider = CoverageJSONItemProvider(self.layer_manager)
